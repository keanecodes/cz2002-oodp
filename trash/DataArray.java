...
public class DataArray {
	...
	/*public ArrayList<DataAccessible> read(String filename, DataAccessible obj) throws IOException {
		ArrayList<String> stringArray = (ArrayList) DataAccessHelper.read(filename);
		Class<? extends DataAccessible> type = obj.getClass();
		ArrayList<DataAccessible> objArray= new ArrayList<DataAccessible>();
